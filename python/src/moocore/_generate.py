...
def generate_sequence(
    ...
    *,
    ...
    ``'each_dominates_previous'|'each_dominates_next'``
      ...
      (``each_dominates_next'``) or decreasing (``each_dominates_previous'``)
    ...
    >>> generate_sequence(5, 2, "each_dominates_previous", seed=42)
    array([[0.85859792, 0.97562235],
           [0.77395605, 0.78606431],
           [0.7611397 , 0.69736803],
           [0.12811363, 0.45038594],
           [0.09417735, 0.43887844]])
    >>> generate_sequence(5, 2, "each_dominates_next", seed=42)
