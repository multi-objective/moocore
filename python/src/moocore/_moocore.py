...
def hv_approx(
    ...
    seed : int or numpy.random.Generator
        Either an integer to seed the NumPy random number generator (RNG) or an instance of Numpy-compatible RNG.
        ``None`` uses the default RNG of Numpy.
    method :
    ...
    Notes
    -----
    This function implements the method proposed by
    ...
    In the default ``method="DZ2019-HW"``, the weights :math:`w^{(i)}, i=1\ldots n`
    ...
    :math:`x` is independently sampled from the standard normal
