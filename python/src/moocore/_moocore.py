...
def pareto_rank(
    ...
    :footcite:t:`Jen03`. For 3D points, it uses a :math:`O(k \cdot n \log
    n)` algorithm, where :math:`k` is the number of fronts in the output.  With
    higher dimensions, it uses the naive :math:`O(n^3)` algorithm.
