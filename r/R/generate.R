...
#'    positive orthant of the hypersphere.  Sampling from the uniform
#'    distribution \citep{LacKlaFon2017box} would not result in a uniform
#'    sampling when projected onto the surface of the hypersphere.
#'
#'   }
...
generate_ndset <- function(n, d, method, seed = NULL, integer = FALSE)
{
  ...
  sample_cliff_concave <- function() {
    ...
    x[, -(1:2)] <- matrix(runif(n * (d - 2L)), nrow = n, ncol = d - 2L)
    x
  }
