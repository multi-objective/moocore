...
#'
#' For 2D and 3D, the algorithm used
#' \citep{FonPaqLop06:hypervolume,BeuFonLopPaqVah09:tec} has \eqn{O(n \log n)}
#' complexity, where \eqn{n} is the number of input points.
#'
#' For 4D, the algorithm used is \eqn{\text{HV4D}^{+}} \citep{GueFon2017hv4d}, which has
#' \eqn{O(n^2)} complexity.  Compared to the [original
