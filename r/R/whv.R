...
#'
#' @param dist (`character(1)`) weight distribution type. See Details.
#'
#' @param seed (`integer(1)`) random seed.
#'
#' @param mu (`numeric()`) parameter of the weight distribution. See Details.
#'
#' @details
