...
This example illustrates how to sample random sets with mutually
nondominated points.
...
![](generate_files/figure-html/generate_rnd_2d-1.png)
...
![](generate_files/figure-html/generate_rnd_2d_int-1.png)
...
non-linear transformation to a `concave-sphere` set, resulting in a
convex transformation of the standard simplex.
...
Naive methods for sampling such sets usually sample points uniformly in
the hypercube and project them into a lower dimensional manifold
([Lacour, Klamroth, and Fonseca 2017](#ref-LacKlaFon2017box)), e.g., the
standard simplex or the positive orthant of the hypersphere. However,
such projections do not preserve the uniformity of the sampling, that
is, not all points in the manifold have the same probability of being
sampled.

The function
[`moocore::generate_ndset()`](https://multi-objective.github.io/moocore/r/reference/generate_ndset.md)
produces a uniform sampling on the manifold, as shown in the following
examples:
...
Lacour, Renaud, Kathrin Klamroth, and Carlos M. Fonseca. 2017. “A Box
Decomposition Algorithm to Compute the Hypervolume Indicator.”
*Computers & Operations Research* 79: 347–60.
<https://doi.org/10.1016/J.COR.2016.06.021>.
