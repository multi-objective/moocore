...
and [`bbotk`](https://cran.r-project.org/package=bbotk) for any number
of objectives. In addition,
[`GPGame`](https://cran.r-project.org/package=GPGame) calculates wrong
values with repeated coordinates
([vpicheny/GPGame#2](https://github.com/vpicheny/GPGame/issues/2)).
...
files <- list(
  ...
  "ran4d"=list(dataset="ran.9000pts.4d.10.xz", N=geomspace(1000, 40000, 10)),
  "rmnk-10d"=list(dataset="rmnk_0.0_10_16_1_0_ref.txt.xz", N=geomspace(1000, 30000, 10))
)
