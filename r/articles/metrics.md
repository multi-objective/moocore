...
correctly measure $`A`$ as better than $`B`$ (remember that hypervolume
must be maximized) and
...
Henggeler Antunes, and Carlos A. Coello Coello, vol. 9018. Lecture Notes
