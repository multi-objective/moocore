...
test_that("Doctest: hv_approx_fpras", {
  ...
  expect_equal(hv_approx_fpras(x, ref = 10, epsilon = 0.1, delta = 0.2, seed = 42),
  38.1446, tolerance = 1e-04)
  expect_equal(hv_approx_fpras(x, ref = 10, epsilon = 0.01, delta = 0.2, seed = 42),
  37.9541, tolerance = 1e-04)
})
