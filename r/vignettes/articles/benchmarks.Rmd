...
The following plots compare the speed of finding (non)dominated solutions, equivalent to `moocore::is_nondominated()`, in 2D, 3D, 4D and 10D.
The plots show that [`moocore`][moocore] is always faster than [`bbotk`][bbotk].
