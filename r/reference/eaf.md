...
proposed by Fonseca et al. (2011) , which have complexity \\O(m\log m +
nm)\\ in 2D and \\O(n^2 m \log m)\\ in 3D, where \\n\\ is the number of
input sets and \\m\\ is the total number of input points.
