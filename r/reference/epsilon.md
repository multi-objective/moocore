...
In the case of minimization of objective \\i\\, \\epsilon(a_i,b_i)\\ is
computed as \\a_i/b_i\\ for the multiplicative variant (respectively,
\\a_i - b_i\\ for the additive variant), whereas in the case of
maximization of objective \\i\\, \\epsilon(a_i,b_i) = b_i/a_i\\ for the
multiplicative variant (respectively, \\b_i - a_i\\ for the additive
