...
different properties. For example the method `convex-simplex` squares
the points generated by method `simplex`, resulting in a convex
...
The method `convex-simplex` implemented in
[`moocore::generate_ndset()`](https://multi-objective.github.io/moocore/r/reference/generate_ndset.md)
is different from the *concave* method proposed by Bringmann and
Friedrich ([2012](#ref-BriFri2012tcs)).
...
Ishibuchi et al. ([2019](#ref-IshHeSha2019regular)) analyze the
differences between *regular* and *inverted* shapes, shown below on the
left and right figures, respectively. The differences between `simplex`
and `inverted-simplex` are not noticeable in 2D, but are significant in
higher dimensions.
...
computing the hypervolume ([Emmerich and Fonseca
2011](#ref-EmmFon2011emo); [Guerreiro and Fonseca
2018](#ref-GueFon2017hv4d)), due to its particular structure.
...
([Lacour et al. 2017](#ref-LacKlaFon2017box)), e.g., the standard
simplex or the positive orthant of the hypersphere. However, such
projections do not preserve the uniformity of the sampling, that is, not
all points in the manifold have the same probability of being sampled.
...
Bringmann, Karl, and Tobias Friedrich. 2012. “Approximating the Least
Hypervolume Contributor: NP-Hard in General, but Fast in Practice.”
*Theoretical Computer Science* 425: 104–16.
<https://doi.org/10.1016/j.tcs.2010.09.026>.

Emmerich, Michael T. M., and Carlos M. Fonseca. 2011. “Computing
...
Optimization, EMO 2011*, edited by R. H. C. Takahashi, Kalyanmoy Deb,
Elizabeth F. Wanner, and Salvatore Greco, vol. 6576. Lecture Notes in
Computer Science. Springer.
<https://doi.org/10.1007/978-3-642-19893-9_9>.

Guerreiro, Andreia P., and Carlos M. Fonseca. 2018. “Computing and
Updating Hypervolume Contributions in up to Four Dimensions.” *IEEE
Transactions on Evolutionary Computation* 22 (3): 449–63.
<https://doi.org/10.1109/tevc.2017.2729550>.

Ishibuchi, Hisao, Linjun He, and Ke Shang. 2019. “Regular Pareto Front
Shape Is Not Realistic.” *Proceedings of the 2019 Congress on
Evolutionary Computation (CEC 2019)* (Piscataway, NJ), June, 2034–41.
<https://doi.org/10.1109/cec.2019.8790342>.
