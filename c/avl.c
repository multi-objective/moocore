...
static int
avl_check_balance(avl_node_t * avlnode)
{
#ifdef AVL_DEPTH
    int d;
...
#ifdef AVL_COUNT
unsigned int
avl_count(const avl_tree_t * avltree)
{
    return NODE_COUNT(avltree->top);
}

avl_node_t *
avl_at(const avl_tree_t * avltree, unsigned int index)
{
    avl_node_t * avlnode;
    unsigned int c;
...
unsigned int
avl_index(const avl_node_t * avlnode)
{
    avl_node_t * next;
    unsigned int c;
...
int
avl_search_closest(const avl_tree_t * avltree, const void * item,
                   avl_node_t ** avlnode)
{
    avl_node_t * node;
    avl_compare_t cmp;
 ...
 */
avl_node_t *
avl_search(const avl_tree_t * avltree, const void * item)
{
    avl_node_t * node;
...
void
avl_free_nodes(avl_tree_t * avltree)
{
 ...
 */
void
avl_free_tree(avl_tree_t * avltree)
{
...
avl_node_t *
avl_init_node(avl_node_t * newnode, void * item)
{
    if (newnode) {
...
avl_node_t *
avl_insert_node(avl_tree_t * avltree, avl_node_t * newnode)
{
    avl_node_t * node;
 ...
 */
avl_node_t *
avl_insert(avl_tree_t * avltree, void * item)
{
    avl_node_t * newnode;
...
void *
avl_delete_node(avl_tree_t * avltree, avl_node_t * avlnode)
{
    void * item = NULL;
    if (avlnode) {
        item = avlnode->item;
...
void *
avl_delete(avl_tree_t * avltree, const void * item)
{
    return avl_delete_node(avltree, avl_search(avltree, item));
}

avl_node_t *
avl_fixup_node(avl_tree_t * avltree, avl_node_t * newnode)
{
