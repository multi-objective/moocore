...
{
    return gd_common(dim, minmax, points_a, size_a, points_r, size_r,
...
IGD_minmax(int dim, const signed char * restrict minmax,
           ...
           const double * restrict points_r, int size_r)
{
    return gd_common(dim, minmax, points_r, size_r, points_a, size_a,
                     /*plus=*/false, /*psize=*/false,
                     /*p=*/(uint_fast8_t)1);
}
...
IGD(const double * restrict data, int nobj, int npoints,
    const double * restrict ref, int ref_size, const bool * restrict maximise)
{
...
_attr_maybe_unused static double
IGD_plus(const double * restrict data, int nobj, int npoints,
...
avg_Hausdorff_dist_minmax(int dim, const signed char * restrict minmax,
                          ...
                          unsigned int p)
{
    double gd_p = gd_common(dim, minmax, points_a, size_a, points_r, size_r,
                            /*plus=*/false, /*psize=*/true, (uint_fast8_t)p);

    double igd_p = gd_common(dim, minmax, points_r, size_r, points_a, size_a,
                             /*plus=*/false, /*psize=*/true, (uint_fast8_t)p);
...
{
    const signed char * minmax = minmax_from_bool((dimension_t)nobj, maximise);
    double value = avg_Hausdorff_dist_minmax(nobj, minmax, data, npoints, ref,
                                             ref_size, p);
    free((void *)minmax);
    return (value);
}
