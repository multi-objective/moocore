...
{
    ASSUME(1 <= dim && dim <= MOOCORE_DIMENSION_MAX);
    // Generated by harmonious_seq.py
    static const long double recip_phi_d[] = {
        0x1.3c6ef372fe94f82be73980c0b9db9068p-01L, // d = 1, value = 0.6180339887498949
        0x1.827f5352054c651e869fee365b2ee496p-01L, // d = 2, value = 0.7548776662466927
        0x1.a36a9465a325da073fb954fadd3bfc1ep-01L, // d = 3, value = 0.8191725133961645
        0x1.b69e1722eb5c42ca89cf1feab545b792p-01L, // d = 4, value = 0.8566748838545029
        0x1.c33603553a858c666b0ed20913d97206p-01L, // d = 5, value = 0.8812714616335696
        0x1.cc1c56e456a75dd75bdfb98e3acc2a36p-01L, // d = 6, value = 0.8986537126286993
        0x1.d2bc3ba2fa6b001b3da7836af99d4a46p-01L, // d = 7, value = 0.9115923534820549
        0x1.d7dbddb3b007902ac66a769dcced40e8p-01L, // d = 8, value = 0.921599319633983
        0x1.dbf09da830ac4b5b78a071d357d8f69p-01L, // d = 9, value = 0.9295701282320229
        0x1.df447355bfe101fe8e061906ef910894p-01L, // d = 10, value = 0.9360691110777584
        0x1.e2084e4125eaf8bad4252c318d09f94p-01L, // d = 11, value = 0.9414696173216353
        0x1.e45dd9ec23b286dcd71a526afbf60b0cp-01L, // d = 12, value = 0.9460285282856136
        0x1.e65d03e6c54d3fb86d0f3719cc312b34p-01L, // d = 13, value = 0.9499283999636199
        0x1.e817452aaafd610e9fb913ef9fd3d1f6p-01L, // d = 14, value = 0.9533025374016642
        0x1.e999ac4fac81923526609aa9500c8714p-01L, // d = 15, value = 0.956250557637989
        0x1.eaee2d784c7a2a12c3f8fb9f3e0c845ap-01L, // d = 16, value = 0.9588484010075614
        0x1.ec1c812639bb4fcaf0c77ea1b928ce8p-01L, // d = 17, value = 0.9611549719964986
        0x1.ed2abc080172300d8c99d6b7243efe06p-01L, // d = 18, value = 0.9632166633389015
        0x1.ee1db8d5714f2db5cac4578507e8ea5ap-01L, // d = 19, value = 0.9650705109167163
        0x1.eef963ac826a7c42c01de9f69371432p-01L, // d = 20, value = 0.9667464397509393
        0x1.efc0f0b70647ebf090e01491ac5f7e7ep-01L, // d = 21, value = 0.9682688926142332
        0x1.f0770473779aa3295949acf33d7863dp-01L, // d = 22, value = 0.9696580306006599
        0x1.f11dd1d928f6e36afbb5b7bfaa5051cp-01L, // d = 23, value = 0.9709306314075385
        0x1.f1b73133ed1bbcb86ce969d55f87f296p-01L, // d = 24, value = 0.9721007705580216
        0x1.f244b1b08b20119afb70f95f23ee065ap-01L, // d = 25, value = 0.9731803443915511
        0x1.f2c7a6fc9f4badc4ce6165ec81c87cap-01L, // d = 26, value = 0.9741794761063355
        0x1.f34133f695ffb8b5ffd1bd93c5c298d2p-01L, // d = 27, value = 0.9751068342693539
        0x1.f3b253244f82923c4b970872f0f7dfeap-01L, // d = 28, value = 0.9759698850464292
        0x1.f41bdd76057468dfbf6d17f30fb8b3b6p-01L, // d = 29, value = 0.97677509370508
        0x1.f47e8fb85ff198ad0ba7200a8f43f12cp-01L, // d = 30, value = 0.9775280869070884
        0x1.f4db0effcb296f3423b8035a7f4efee8p-01L, // d = 31, value = 0.9782337844131516
    };
...
static inline void
Rphi_next_non_recurrent(double * restrict dest, dimension_t dim, uint_fast32_t i,
                        double seed, const long double * restrict alpha)
{
    ASSUME(1 <= dim && dim <= MOOCORE_DIMENSION_MAX);
    for (dimension_t d = 0; d < dim; d++) {
        dest[d] = STATIC_CAST(double, fractl(i * alpha[d] + seed));
    }
}

static inline void
Rphi_next_recurrent(double * restrict u, dimension_t dim, const long double * restrict alpha)
{
    ASSUME(2 <= dim && dim <= MOOCORE_DIMENSION_MAX);
    for (dimension_t d = 0; d < dim; d++) {
...
/*
  Fang and Wang (1994)
  Sec 4.2.1 https://erho.weebly.com/uploads/2/7/8/4/27841631/computation_of_multivariate_normal_and_t_probabilities.pdf
  Alan Genz • Frank Bretz. Computation of Multivariate Normal and t Probabilities.
*/
static void
...
#ifdef _OPENMP
            Rphi_next_non_recurrent(u, dim - 1, j, seed, alpha);
#else
            Rphi_next_recurrent(u, dim - 1, alpha);
#endif
